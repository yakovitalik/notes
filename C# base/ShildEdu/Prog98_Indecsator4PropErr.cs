// Использование индексатора для создания отказоустойчивого массива3
...
namespace Program98
{
	class FailSoftArray
	{
		...
		bool ErrFlag;			// теперь это частная(закрытая) переменная,
								// означающая результат последней операции
