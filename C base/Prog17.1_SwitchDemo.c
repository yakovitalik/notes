/* Программа предоставляет пользователю меню опций и принимает 
выбор пользователя, после чего использует выражение switch для выолнения одной-двух 
строк кода в соответствии с выбором пользователя. (Реализации выполняемых действий нет, 
данная программа представляет просто набор заглушек, демонстрирующих ценность выражения 
switch) */
