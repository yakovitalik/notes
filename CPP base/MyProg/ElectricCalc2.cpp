...
void raschet3()			// Расчет 3
{
	...
	// расчет значений
	fullpower = sqrt((actpower * actpower) + (reactpower * reactpower));
	cosf = actpower / fullpower;
	curent = fullpower / (SQR3 * voltage);
	cout << "Расчет выполнен!\n\n";

	// вывод значений
	cout << "Полная мощность будет равна: " << fullpower << " кВА" << endl;
	cout << "cos ф равен: " << cosf << endl;
...
{
	// ввод значений пользователем
	cout << "Введите значение мощность трансформатора, кВА: \n";
	cin >> fullpower;
	...
	// вывод значений
	cout << "Загрузка трансформатора составляет: " << zagrkof << " \%";
	cout << "Для продолжения нажмите клавишу Enter...";
	getchar();
}
//////////////////////////////////////////////////////////////////////////////